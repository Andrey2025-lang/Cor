...
setInterval(function(){
    ...
    for (i = v; i--;){
        ...
        E = u.y - q[1];
        G = Math.sqrt(D*D + E*E);
        10 > G && (0.95 < R() ? u.q = ~~(R() * v) : (0.99 < R() && (u.D *= -1), u.q += u.D, u.q > v - 1 ? u.q = 0 : u.q < 0 && (u.q = v - 1)));
        u.X += -D / G * u.S;
        u.Y += -E / G * u.S;
        u.x += u.X;
        u.y += u.Y;
 ...
 // ✨ Texto hermoso sobre el corazón
a.save();
a.font = "32px 'Great Vibes'";
a.fillStyle = "rgba(255, 0, 0, 0.9)"; // rojo elegante
a.textAlign = "center";
a.textBaseline = "bottom";

// ✨ Sombra suave brillante
a.shadowColor = "rgba(255, 0, 0, 0.9)";
a.shadowBlur = 25;

// 📝 Texto
a.fillText("Con mucho cariño para ti", WIDTH / 2, HEIGHT / 2 - 200);
